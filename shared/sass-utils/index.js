 ...
 *   }
 * });
 * // SassMap => '("key": "value"index., "nested": ("complex//:key": (null, 4)))'
 *
 ...
 * @param {boolean} [options.quotes=false] - controls whether returned SassStrings are quoted. input strings that contain quotes will always return a quoted SassString even if this flag is false.
